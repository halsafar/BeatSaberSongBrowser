...
namespace SongBrowserPlugin
{
    ...
    public class SongBrowserModel
    {
        ...
        private void SortPlayCount(List<StandardLevelSO> levels, GameplayMode gameplayMode)
        {
            ...
            Dictionary<string, int> _levelIdToPlayCount = levels.ToDictionary(x => x.levelID, x => difficultyIterator.Sum(difficulty => playerData.GetPlayerLevelStatsData(x.levelID, difficulty, gameplayMode).playCount));
            _sortedSongs = levels
                .AsQueryable()
